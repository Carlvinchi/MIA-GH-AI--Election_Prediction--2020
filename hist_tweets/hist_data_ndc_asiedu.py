...
fileName = 'NDC_hista_siedu_data.csv'
def get_tweets():
    tweetCriteria = got.manager.TweetCriteria().setQuerySearch('asiedu nketia') \
        .setSince("2019-12-01") \
        .setUntil("2020-03-1") \
        .setMaxTweets(2000)
...
if __name__=="__main__":
    ...
    plt.title('A Plot of Sentiments base on Aseidu Nketia tweet data')
