...
searchQuery = 'john dramani mahama'  # this is what we're searching for
maxTweets =10000000   #Some arbitrary large number
tweetsPerQry = 100  # this is the max the API permits
fName = 'Tweets_test/NPP_tweets.csv'  # We'll store the tweets in a text file.
fileName = 'NDC_tweetsjohn_data.csv'
...
plt.title('A Plot of Sentiments base on Mahama tweet data')
