...
fileName = 'NDC_hist_john_data.csv'
def get_tweets():
    tweetCriteria = got.manager.TweetCriteria().setQuerySearch('john dramani mahama') \
        .setSince("2019-12-01") \
        .setUntil("2020-03-1") \
        .setMaxTweets(500)
...
if __name__=="__main__":
    ...
    plt.title('A Plot of Sentiments base on John Mahama tweet data')
